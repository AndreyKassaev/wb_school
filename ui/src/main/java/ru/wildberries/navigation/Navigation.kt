    ...
    Scaffold(
        ...
        NavHost(
            ...
            navigation<Route.EventBase>(
                ...
                composable<Route.Event> { backStackEntry ->
                    val event: Route.Event = backStackEntry.toRoute()
                    EventDetailScreen(
                        viewModel = koinViewModel<EventViewModel>(),
                        event = event,
                        navController = navController
            ...
            navigation<Route.CommunityBase>(
                ...
                composable<Route.Community> { backStackEntry ->
                    val community: Route.Community = backStackEntry.toRoute()
